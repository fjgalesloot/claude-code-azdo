...
- `REVIEWER_CONFIGS` — keyed map of 17 reviewers: `terraform`, `yaml`, `helm`, `cilium`, `dockerfile`, `dotnet_core`, `golang`, `java`, `javascript`, `nextjs`, `php`, `powershell_core`, `python`, `rust`, `sql`, `apex`, `typescript`
